...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateEmail(email) && validatePhone(phone)) {
      ...
      toast.error(
        "El correo electrónico no es válido o el número de teléfono no es válido."
      );
    }
  };
  ...
  return (
    <div
      className={`${bgMain} min-h-screen p-5 flex items-center justify-center transition-colors duration-300`}
    >
      <div
        className={`w-9/10 max-w-md mx-auto ${formBg} p-8 rounded-lg shadow-lg m-5 text-white`}
      >
