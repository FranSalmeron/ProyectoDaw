...
const Login = () => {
  ...
  return (
    <div className={`${bgMain} min-h-screen p-5 flex items-center justify-center transition-colors duration-300`}>
      <div className={`w-9/10 max-w-md mx-auto ${formBg} p-8 rounded-lg shadow-lg`}>
        ...
        <form onSubmit={handleLogin}>
            ...
            <div className="flex justify-center mb-4">
                <button
                    type="submit"
                    disabled={loading}
                    className={`w-full py-3 text-white rounded-lg transition duration-300 focus:outline-none ${btnBg} ${btnFocusRing} ${loading ? "cursor-not-allowed opacity-70" : ""}`}
                >
