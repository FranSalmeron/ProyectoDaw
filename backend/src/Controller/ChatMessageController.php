...
class ChatMessageController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('chat_message/new.html.twig', [
            'chat_message' => $chatMessage,
            'form' => $form,
        ]);
    }

    #[Route('/{chat}', name: 'app_chat_message_show', methods: ['GET'])]
    ...
    #[Route('/{chat}/edit', name: 'app_chat_message_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, ChatMessage $chatMessage, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('chat_message/edit.html.twig', [
            'chat_message' => $chatMessage,
            'form' => $form,
        ]);
    }

    #[Route('/{chat}', name: 'app_chat_message_delete', methods: ['POST'])]
    public function delete(Request $request, ChatMessage $chatMessage, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$chatMessage->getChat(), $request->request->get('_token'))) {
