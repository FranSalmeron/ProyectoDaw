...
class App_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.Y2EzsVv' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Y2EzsVvService()
    {
        return $this->privates['.service_locator.Y2EzsVv'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        $a = ($this->privates['.service_locator.Y2EzsVv'] ?? $this->get_ServiceLocator_Y2EzsVvService());
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.aiJ2i.F'] ?? ($this->privates['.security.request_matcher.aiJ2i.F'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(api|chat|ChatMessage)')));
        }, 4));
    }
