...
class App_KernelDevDebugContainer extends Container
{
    ...
    /**
     * Gets the private '.service_locator.K7rDYp9' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_K7rDYp9Service()
    {
        return $this->privates['.service_locator.K7rDYp9'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        $a = ($this->privates['.service_locator.K7rDYp9'] ?? $this->get_ServiceLocator_K7rDYp9Service());
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.rzSi_me'] ?? ($this->privates['.security.request_matcher.rzSi_me'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(api)')));
        }, 7));
    }
