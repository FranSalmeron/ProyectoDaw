...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ChatCarController' => 'getChatCarControllerService',
    ...
    protected function get_Container_Private_ProfilerService()
    {
        ...
        $instance->add($f);
        $instance->add($this->load('getGosWebSocket_DataCollector_WebsocketService'));
    ...
    /**
     * Gets the private '.service_locator.IxAX6o6' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_IxAX6o6Service()
    {
        return $this->privates['.service_locator.IxAX6o6'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        $a = ($this->privates['.service_locator.IxAX6o6'] ?? $this->get_ServiceLocator_IxAX6o6Service());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('gos_web_socket_server_host', $this->getEnv('WEB_SOCKET_HOST'));
        $instance->addGlobal('gos_web_socket_server_port', $this->getEnv('WEB_SOCKET_PORT'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'upload_dir' => (\dirname(__DIR__, 4).'/public/uploads/images'),
