...
return [
    ...
    [ // $dynamicRoutes
        ...
        340 => [[['_route' => 'app_car_show', '_controller' => 'App\\Controller\\CarController::show'], ['CarID'], ['GET' => 0], null, false, true, null]],
        353 => [[['_route' => 'app_car_edit', '_controller' => 'App\\Controller\\CarController::edit'], ['CarID'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        361 => [[['_route' => 'app_car_delete', '_controller' => 'App\\Controller\\CarController::delete'], ['CarID'], ['POST' => 0], null, false, true, null]],
