...
class getConsole_CommandLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'gos_web_socket.command.websocket_server' => ['privates', '.gos_web_socket.command.websocket_server.lazy', 'get_GosWebSocket_Command_WebsocketServer_LazyService', true],
            ...
            'gos_pubsub_router.command.debug_router' => ['privates', '.gos_pubsub_router.command.debug_router.lazy', 'get_GosPubsubRouter_Command_DebugRouter_LazyService', true],
