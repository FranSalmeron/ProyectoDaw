...
class RoutersConfig 
{
    ...
    public function __construct(array $value = [])
    {
        if (array_key_exists('resources', $value)) {
            $this->_usedProperties['resources'] = true;
            $this->resources = array_map(function ($v) { return \is_array($v) ? new \Symfony\Config\GosPubsubRouter\RoutersConfig\ResourcesConfig($v) : $v; }, $value['resources']);
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['resources'])) {
            $output['resources'] = array_map(function ($v) { return $v instanceof \Symfony\Config\GosPubsubRouter\RoutersConfig\ResourcesConfig ? $v->toArray() : $v; }, $this->resources);
        }
