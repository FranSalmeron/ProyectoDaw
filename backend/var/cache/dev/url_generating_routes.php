...
return [
    ...
    'app_car_favorite_delete' => [['userId', 'carId'], ['_controller' => 'App\\Controller\\CarFavoriteController::delete'], [], [['variable', '/', '[^/]++', 'carId', true], ['variable', '/', '[^/]++', 'userId', true], ['text', '/favorite/favorite']], [], [], []],
