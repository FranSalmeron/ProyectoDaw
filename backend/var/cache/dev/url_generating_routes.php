...
return [
    ...
    'app_ChatMessage_message_get_all' => [['chatId'], ['_controller' => 'App\\Controller\\ChatMessageController::getAllMessages'], [], [['text', '/messages'], ['variable', '/', '[^/]++', 'chatId', true], ['text', '/ChatMessage']], [], [], []],
