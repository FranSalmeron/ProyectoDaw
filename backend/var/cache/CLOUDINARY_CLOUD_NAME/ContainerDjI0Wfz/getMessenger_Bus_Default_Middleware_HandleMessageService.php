 ...
 */
class getMessenger_Bus_Default_Middleware_HandleMessageService extends App_KernelCLOUDINARY_CLOUD_NAMEContainer
{
    /*
    ...
    {
        $container->privates['messenger.bus.default.middleware.handle_message'] = $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(new \Symfony\Component\Messenger\Handler\HandlersLocator(['App\\Message\\LoadMessagesMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.1r7HQ_E'] ?? $container->load('get_Messenger_HandlerDescriptor_1r7HQEService'));
