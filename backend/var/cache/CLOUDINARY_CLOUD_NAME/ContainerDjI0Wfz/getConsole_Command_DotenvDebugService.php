 ...
 */
class getConsole_Command_DotenvDebugService extends App_KernelCLOUDINARY_CLOUD_NAMEContainer
{
    /*
    ...
    {
        $container->privates['console.command.dotenv_debug'] = $instance = new \Symfony\Component\Dotenv\Command\DebugCommand('CLOUDINARY_CLOUD_NAME', \dirname(__DIR__, 4));
