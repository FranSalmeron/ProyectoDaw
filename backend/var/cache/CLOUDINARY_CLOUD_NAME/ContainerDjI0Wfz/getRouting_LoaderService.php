 ...
 */
class getRouting_LoaderService extends App_KernelCLOUDINARY_CLOUD_NAMEContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $d = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'CLOUDINARY_CLOUD_NAME');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($c, 'CLOUDINARY_CLOUD_NAME'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($c, 'CLOUDINARY_CLOUD_NAME'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($c, 'CLOUDINARY_CLOUD_NAME'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($c, 'CLOUDINARY_CLOUD_NAME'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($c, 'CLOUDINARY_CLOUD_NAME'));
