 ...
 */
class getSecurity_EventDispatcher_ChatListService extends App_KernelProdContainer
{
    /*
    ...
    {
        $container->privates['security.event_dispatcher.ChatList'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.ChatList'] ?? $container->load('getSecurity_Listener_UserChecker_ChatListService'));
