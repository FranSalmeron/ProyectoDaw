...
class getTwigService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addGlobal('gos_web_socket_server_host', $container->getEnv('WEB_SOCKET_HOST'));
        $instance->addGlobal('gos_web_socket_server_port', $container->getEnv('WEB_SOCKET_PORT'));
