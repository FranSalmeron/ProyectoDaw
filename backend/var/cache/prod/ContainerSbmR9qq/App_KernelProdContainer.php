...
class App_KernelProdContainer extends Container
{
    ...
    protected function getSerializerService()
    {
        ...
        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($d), 1 => $g, 2 => $j, 3 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($k, [], $l), 4 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $l), 5 => $j, 6 => $g, 7 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($h, $b, $c, $m, NULL, $k, NULL, $l), 8 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($h, $n, $k), 9 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($k, false), 10 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(false), 11 => new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), 12 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false), 13 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 14 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($h, $b, $c, $n, $m, $o, $d, $l, $p, [], new RewindableGenerator(function () {
            yield 0 => ($this->privates['api_platform.messenger.data_transformer'] ?? $this->load('getApiPlatform_Messenger_DataTransformerService'));
        }, 1), $q), 15 => new \ApiPlatform\Serializer\ItemNormalizer($b, $c, $n, $m, $d, $l, $p, ($this->privates['api_platform.item_data_provider'] ?? $this->getApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            yield 0 => ($this->privates['api_platform.messenger.data_transformer'] ?? $this->load('getApiPlatform_Messenger_DataTransformerService'));
        }, 1), $h, $q), 16 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 17 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $l), 18 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($p, $l, $a, $r, NULL)), 19 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 24 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 25 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($o, $m, $n, NULL), 'page', 'pagination', $h, $d), $h, $m, $i), 26 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 27 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($s, $n, $o), 28 => $s], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $e, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'gos_web_socket.server.port': $value = $this->getEnv('WEB_SOCKET_PORT'); break;
            case 'gos_web_socket.server.host': $value = $this->getEnv('WEB_SOCKET_HOST'); break;
