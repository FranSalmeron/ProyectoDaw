 ...
 */
class getSecurity_EventDispatcher_TransactionsStatisticsService extends App_KernelProdContainer
{
    /*
     * Gets the private 'security.event_dispatcher.transactionsStatistics' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->privates['security.event_dispatcher.transactionsStatistics'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.transactionsStatistics'] ?? $container->load('getSecurity_Listener_UserChecker_TransactionsStatisticsService'));
