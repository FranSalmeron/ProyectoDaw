...
class App_KernelProdContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AttributeDriver($this->parameters['api_platform.resource_class_directories'], true), 'App\\Entity');
    ...
    /*
     * Gets the private '.service_locator.xesj7wL' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Xesj7wLService()
    {
        return $this->privates['.service_locator.xesj7wL'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.transactionsStatistics' => ['privates', 'security.firewall.map.context.transactionsStatistics', 'getSecurity_Firewall_Map_Context_TransactionsStatisticsService', true],
            ...
            'security.firewall.map.context.transactionsStatistics' => '?',
    ...
    {
        $a = ($this->privates['.service_locator.xesj7wL'] ?? $this->get_ServiceLocator_Xesj7wLService());
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.transactionsStatistics' => ($this->privates['.security.request_matcher.09CQZjV'] ?? ($this->privates['.security.request_matcher.09CQZjV'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/transactions/statistics')));
    ...
    protected function getSerializerService()
    {
        ...
        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => new \ApiPlatform\RamseyUuid\Serializer\UuidDenormalizer(), 2 => $e, 3 => $j, 4 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($k, [], $l), 5 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $l), 6 => $j, 7 => $e, 8 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $m, NULL, $k, NULL, $l), 9 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($f, $n, $k), 10 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($k, false), 11 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(false), 12 => new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), 13 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false), 14 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 15 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $n, $m, $o, $a, $l, $p, [], new RewindableGenerator(function () {
            yield 0 => ($this->privates['api_platform.messenger.data_transformer'] ?? $this->load('getApiPlatform_Messenger_DataTransformerService'));
        }, 1), $q), 16 => new \ApiPlatform\Serializer\ItemNormalizer($g, $h, $n, $m, $a, $l, $p, ($this->privates['api_platform.item_data_provider'] ?? $this->getApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            yield 0 => ($this->privates['api_platform.messenger.data_transformer'] ?? $this->load('getApiPlatform_Messenger_DataTransformerService'));
        }, 1), $f, $q), 17 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $l), 19 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($p, $l, $b, $r, NULL)), 20 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 24 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 25 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 26 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($o, $m, $n, NULL), 'page', 'pagination', $f, $a), $f, $m, $i), 27 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 28 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($s, $n, $o), 29 => $s], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $c, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
