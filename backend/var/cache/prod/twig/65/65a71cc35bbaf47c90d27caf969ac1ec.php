...
class __TwigTemplate_3f4edc396178271189a1290049e21620 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("base.html.twig", "chat_car/show.html.twig", 1);
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        yield ((CoreExtension::getAttribute($this->env, $this->source, ($context["chat"] ?? null), "createdDate", [], "any", false, false, false, 16)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Twig\Extension\CoreExtension']->formatDate(CoreExtension::getAttribute($this->env, $this->source, ($context["chat"] ?? null), "createdDate", [], "any", false, false, false, 16), "Y-m-d H:i:s"), "html", null, true)) : (""));
        yield "</td>
            </tr>
        </tbody>
    </table>
