...
/* car/show.html.twig */
class __TwigTemplate_c91b63b02eee59524de0b52dd6814476 extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 72
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["car"] ?? null), "images", [], "any", false, false, false, 72)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(json_encode(CoreExtension::getAttribute($this->env, $this->source, ($context["car"] ?? null), "images", [], "any", false, false, false, 72)), "html", null, true)) : (""));
        yield "</td>
            </tr>
            <tr>
                <th>CarSold</th>
                <td>";
        // line 76
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["car"] ?? null), "CarSold", [], "any", false, false, false, 76)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Yes") : ("No"));
        yield "</td>
            </tr>
        </tbody>
    </table>
