...
/* car/index.html.twig */
class __TwigTemplate_236cb02aaf522fb38e5ffb7b47f81fb9 extends Template
{
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["car"]) {
            ...
            yield "</td>
                <td>";
            // line 49
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["car"], "images", [], "any", false, false, false, 49)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(json_encode(CoreExtension::getAttribute($this->env, $this->source, $context["car"], "images", [], "any", false, false, false, 49)), "html", null, true)) : (""));
            yield "</td>
                <td>";
            // line 50
            yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["car"], "CarSold", [], "any", false, false, false, 50)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("Yes") : ("No"));
            yield "</td>
                <td>
                    <a href=\"";
            // line 52
