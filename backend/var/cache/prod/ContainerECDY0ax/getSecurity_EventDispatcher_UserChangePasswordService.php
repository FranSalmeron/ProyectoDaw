 ...
 */
class getSecurity_EventDispatcher_UserChangePasswordService extends App_KernelProdContainer
{
    /*
    ...
    {
        $container->privates['security.event_dispatcher.UserChangePassword'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () use ($container) {
            return ($container->privates['security.listener.user_checker.UserChangePassword'] ?? $container->load('getSecurity_Listener_UserChecker_UserChangePasswordService'));
