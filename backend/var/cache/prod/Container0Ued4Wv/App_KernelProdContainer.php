...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\CarFavoriteController' => 'getCarFavoriteControllerService',
            'App\\Controller\\ChatController' => 'getChatControllerService',
            'App\\Controller\\ChatMessageController' => 'getChatMessageControllerService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AttributeDriver($this->parameters['api_platform.resource_class_directories'], true), 'App\\Entity');
        ...
        $c->setQueryCache(($this->privates['doctrine.system_cache_pool'] ?? $this->getDoctrine_SystemCachePoolService()));
        $c->setResultCache(($this->privates['doctrine.result_cache_pool'] ?? $this->getDoctrine_ResultCachePoolService()));
        ...
        $c->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\CarFavoriteRepository' => ['privates', 'App\\Repository\\CarFavoriteRepository', 'getCarFavoriteRepositoryService', true],
    ...
    /*
     * Gets the private '.service_locator.gcVH11s' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_GcVH11sService()
    {
        return $this->privates['.service_locator.gcVH11s'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'security.firewall.map.context.ChatCreate' => ['privates', 'security.firewall.map.context.ChatCreate', 'getSecurity_Firewall_Map_Context_ChatCreateService', true],
            'security.firewall.map.context.ChatList' => ['privates', 'security.firewall.map.context.ChatList', 'getSecurity_Firewall_Map_Context_ChatListService', true],
            'security.firewall.map.context.ChatMessageSend' => ['privates', 'security.firewall.map.context.ChatMessageSend', 'getSecurity_Firewall_Map_Context_ChatMessageSendService', true],
            'security.firewall.map.context.UserChangePassword' => ['privates', 'security.firewall.map.context.UserChangePassword', 'getSecurity_Firewall_Map_Context_UserChangePasswordService', true],
            'security.firewall.map.context.csrf_token' => ['privates', 'security.firewall.map.context.csrf_token', 'getSecurity_Firewall_Map_Context_CsrfTokenService', true],
            ...
            'security.firewall.map.context.refreshToken' => ['privates', 'security.firewall.map.context.refreshToken', 'getSecurity_Firewall_Map_Context_RefreshTokenService', true],
            'security.firewall.map.context.userIndex' => ['privates', 'security.firewall.map.context.userIndex', 'getSecurity_Firewall_Map_Context_UserIndexService', true],
        ], [
            'security.firewall.map.context.ChatCreate' => '?',
            'security.firewall.map.context.ChatList' => '?',
            'security.firewall.map.context.ChatMessageSend' => '?',
            'security.firewall.map.context.UserChangePassword' => '?',
            'security.firewall.map.context.csrf_token' => '?',
            'security.firewall.map.context.login' => '?',
            'security.firewall.map.context.refreshToken' => '?',
            'security.firewall.map.context.userIndex' => '?',
        ]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Gks+ilSMuY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cXZFuRO1mR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Rj40vWqPvb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-Z4sE1dJkR', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bg5husFMps', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('nLA4KSlqUr', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Bt91r2AN2j', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-DUG9IAN24', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Wau6wMpj-x', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zxRenCpzG0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('55NHs3attw', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false))));
    ...
    {
        return $this->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sutgXUCZ1S', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getSecurity_ContextListener_0Service()
    {
        ...
        }, 1), 'UserChangePassword', ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->privates['security.event_dispatcher.UserChangePassword'] ?? $this->getSecurity_EventDispatcher_UserChangePasswordService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), [0 => ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    protected function getSecurity_ContextListener_1Service()
    {
        return $this->privates['security.context_listener.1'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.user.provider.concrete.app_user_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppUserProviderService'));
        }, 1), 'userIndex', ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->privates['security.event_dispatcher.userIndex'] ?? $this->getSecurity_EventDispatcher_UserIndexService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), [0 => ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    protected function getSecurity_ContextListener_2Service()
    {
        return $this->privates['security.context_listener.2'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.user.provider.concrete.app_user_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppUserProviderService'));
        }, 1), 'ChatList', ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->privates['security.event_dispatcher.ChatList'] ?? $this->getSecurity_EventDispatcher_ChatListService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), [0 => ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), 1 => 'enableUsageTracking']);
    }
    ...
    protected function getSecurity_ContextListener_3Service()
    {
        return $this->privates['security.context_listener.3'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->privates['security.untracked_token_storage'] ?? ($this->privates['security.untracked_token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.user.provider.concrete.app_user_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppUserProviderService'));
        }, 1), 'ChatCreate', ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), ($this->privates['security.event_dispatcher.ChatCreate'] ?? $this->getSecurity_EventDispatcher_ChatCreateService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), [0 => ($this->privates['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), 1 => 'enableUsageTracking']);
    }

    /*
     * Gets the private 'security.event_dispatcher.ChatCreate' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    protected function getSecurity_EventDispatcher_ChatCreateService()
    {
        $this->privates['security.event_dispatcher.ChatCreate'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.session.ChatCreate'] ?? $this->load('getSecurity_Listener_Session_ChatCreateService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.user_checker.ChatCreate'] ?? $this->load('getSecurity_Listener_UserChecker_ChatCreateService'));
    ...
    /*
     * Gets the private 'security.event_dispatcher.ChatList' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    protected function getSecurity_EventDispatcher_ChatListService()
    {
        $this->privates['security.event_dispatcher.ChatList'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.session.ChatList'] ?? $this->load('getSecurity_Listener_Session_ChatListService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.user_checker.ChatList'] ?? $this->load('getSecurity_Listener_UserChecker_ChatListService'));
        }, 1 => 'preCheckCredentials'], 256);
        $instance->addListener('security.authentication.success', [0 => function () {
            return ($this->privates['security.listener.user_checker.ChatList'] ?? $this->load('getSecurity_Listener_UserChecker_ChatListService'));
        }, 1 => 'postCheckCredentials'], 256);
    ...
    /*
     * Gets the private 'security.event_dispatcher.UserChangePassword' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    protected function getSecurity_EventDispatcher_UserChangePasswordService()
    {
        $this->privates['security.event_dispatcher.UserChangePassword'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.session.UserChangePassword'] ?? $this->load('getSecurity_Listener_Session_UserChangePasswordService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.user_checker.UserChangePassword'] ?? $this->load('getSecurity_Listener_UserChecker_UserChangePasswordService'));
        }, 1 => 'preCheckCredentials'], 256);
        $instance->addListener('security.authentication.success', [0 => function () {
            return ($this->privates['security.listener.user_checker.UserChangePassword'] ?? $this->load('getSecurity_Listener_UserChecker_UserChangePasswordService'));
        }, 1 => 'postCheckCredentials'], 256);
    ...
    /*
     * Gets the private 'security.event_dispatcher.userIndex' shared service.
     *
     * @return \Symfony\Component\EventDispatcher\EventDispatcher
     */
    protected function getSecurity_EventDispatcher_UserIndexService()
    {
        $this->privates['security.event_dispatcher.userIndex'] = $instance = new \Symfony\Component\EventDispatcher\EventDispatcher();

        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [0 => function () {
            return ($this->privates['security.listener.session.userIndex'] ?? $this->load('getSecurity_Listener_Session_UserIndexService'));
        }, 1 => 'onSuccessfulLogin'], 0);
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [0 => function () {
            return ($this->privates['security.listener.user_checker.userIndex'] ?? $this->load('getSecurity_Listener_UserChecker_UserIndexService'));
        }, 1 => 'preCheckCredentials'], 256);
        $instance->addListener('security.authentication.success', [0 => function () {
            return ($this->privates['security.listener.user_checker.userIndex'] ?? $this->load('getSecurity_Listener_UserChecker_UserIndexService'));
        }, 1 => 'postCheckCredentials'], 256);
    ...
    {
        $a = ($this->privates['.service_locator.gcVH11s'] ?? $this->get_ServiceLocator_GcVH11sService());
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.refreshToken' => ($this->privates['.security.request_matcher.zUz4DiV'] ?? ($this->privates['.security.request_matcher.zUz4DiV'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/refreshToken$')));
            yield 'security.firewall.map.context.ChatMessageSend' => ($this->privates['.security.request_matcher.N3f60VL'] ?? ($this->privates['.security.request_matcher.N3f60VL'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ChatMessage/\\d+/send')));
            yield 'security.firewall.map.context.UserChangePassword' => ($this->privates['.security.request_matcher.pDsVPBi'] ?? ($this->privates['.security.request_matcher.pDsVPBi'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/\\d+/change-password')));
            yield 'security.firewall.map.context.userIndex' => ($this->privates['.security.request_matcher.X8Qgzn9'] ?? ($this->privates['.security.request_matcher.X8Qgzn9'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/index')));
            yield 'security.firewall.map.context.ChatList' => ($this->privates['.security.request_matcher.xkdLkU4'] ?? ($this->privates['.security.request_matcher.xkdLkU4'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/chat/index')));
            yield 'security.firewall.map.context.csrf_token' => ($this->privates['.security.request_matcher.KsvN9uG'] ?? ($this->privates['.security.request_matcher.KsvN9uG'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/csrf-token')));
            yield 'security.firewall.map.context.ChatCreate' => ($this->privates['.security.request_matcher.O05mk5k'] ?? ($this->privates['.security.request_matcher.O05mk5k'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/chat/create')));
        }, 8));
    }
    ...
    protected function getSerializerService()
    {
        ...
        $d = ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService());
        $e = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL);

        $f = new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $d, $a)], [0 => $e]));

        $g = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer($f);
        ...
        $j = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer($h, $b, $c, ($this->privates['api_platform.hydra.json_schema.schema_factory'] ?? $this->getApiPlatform_Hydra_JsonSchema_SchemaFactoryService()), ($this->privates['api_platform.json_schema.type_factory'] ?? $this->getApiPlatform_JsonSchema_TypeFactoryService()), ($this->privates['api_platform.operation_path_resolver.router'] ?? $this->getApiPlatform_OperationPathResolver_RouterService()), NULL, $i, NULL, false, 'oauth2', 'application', '', '', [], [], ($this->privates['api_platform.subresource_operation_factory.cached'] ?? $this->getApiPlatform_SubresourceOperationFactory_CachedService()), true, 'page', false, 'itemsPerPage', $this->parameters['api_platform.formats'], false, 'pagination', [], $this->parameters['api_platform.swagger.versions'], ($this->privates['api_platform.identifiers_extractor.cached'] ?? $this->getApiPlatform_IdentifiersExtractor_CachedService()), NULL, true, $f));
        ...
        $n = ($this->privates['api_platform.iri_converter.legacy'] ?? $this->load('getApiPlatform_IriConverter_LegacyService'));
        ...
        $s = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($p, $l, $d, $a, $r, NULL);

        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($d), 1 => new \ApiPlatform\RamseyUuid\Serializer\UuidDenormalizer(), 2 => $g, 3 => $j, 4 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($k, [], $l), 5 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $l), 6 => $j, 7 => $g, 8 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($h, $b, $c, $m, NULL, $k, NULL, $l), 9 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($h, $n, $k), 10 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($k, false), 11 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(false), 12 => new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), 13 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false), 14 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 15 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($h, $b, $c, $n, $m, $o, $d, $l, $p, [], new RewindableGenerator(function () {
            yield 0 => ($this->privates['api_platform.messenger.data_transformer'] ?? $this->load('getApiPlatform_Messenger_DataTransformerService'));
        }, 1), $q), 16 => new \ApiPlatform\Serializer\ItemNormalizer($b, $c, $n, $m, $d, $l, $p, ($this->privates['api_platform.item_data_provider'] ?? $this->getApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            yield 0 => ($this->privates['api_platform.messenger.data_transformer'] ?? $this->load('getApiPlatform_Messenger_DataTransformerService'));
        }, 1), $h, $q), 17 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $l), 19 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($p, $l, $a, $r, NULL)), 20 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 24 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 25 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 26 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($o, $m, $n, NULL), 'page', 'pagination', $h, $d), $h, $m, $i), 27 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 28 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($s, $n, $o), 29 => $s], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $e, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
